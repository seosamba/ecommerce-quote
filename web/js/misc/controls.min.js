...
'<a href="'+$("#website_url").val()+a.id+'.html" target="_blank" title="'+a.id+'">'+$("#website_url").val()+a.id+".html</a>";hideSpinner();showMessage("The quote has been duplicated. <br/>"+d,!1,15E3);recalculate({summary:a})})});$(document).on("blur",".quote-recalculate",function(a){a=$(a.currentTarget);var b=a.data("scope"),d=a.data("type"),h=$(a).data("sid"),f=a.val();if("qty"==d){f=Math.abs(f);if(0==f)return showMessage("You can't set zero qty for product!",!0,3E3),!1;a.val(f)}else if("price"==
d){f=Math.abs(f);if(0==f)return showMessage("You can't set zero price for product!",!0,3E3),!1;a.val(f)}var g={qid:c,type:d,value:f,sid:h};switch(b){case "quote-item":var k=a.data("pid");g.value=accounting.unformat(g.value);a=_update("api/quote/products/id/"+k,g);a.done(function(a){hideSpinner();$.extend(g,{calculateProduct:!0,productId:k,summary:a});recalculate(g,h)});break;case "quote-partial":a=_update("api/quote/quotes/",g),a.done(function(a){hideSpinner();$.extend(g,{summary:a});recalculate(g,
h)})}});$(document).on("change","#quote-discount-rate",function(a){var b={qid:c,type:"taxrate",value:$(a.currentTarget).val()};_update("api/quote/quotes/",b).done(function(a){hideSpinner();$.extend(b,{summary:a});recalculate(b)})});$(document).on("change",".quote-disclaimer-text",function(a){a.preventDefault();$(".quote-control-save").trigger("click");showMessage("Quote notes has been saved",!1,3E3)});$(document).on("keyup","#partial-payment-percentage",function(a){a.preventDefault();var b={qid:c,
...
shipping:$("#shipping-user-address").serialize(),billing:$("#plugin-quote-quoteform").serialize(),mailMessage:a?b:"",errorMessage:l,eventType:d?d:"",paymentType:$("#quote-payment-type-selector").val(),isSignatureRequired:f,partialPaymentPercentage:$("#partial-payment-percentage").val(),ccEmails:h};_update("api/quote/quotes/",a).done(function(a,b,d){hideLoader();if(1==a.error)return showMessage(a.responseText,!0,5E3),!1;processDraggable(c);recalculate({summary:a})})},_update=function(c,a){return $.ajax({type:"put",
url:$("#website_url").val()+c,dataType:"json",data:JSON.stringify(a),beforeSend:showSpinner()})},recalculate=function(c,a){if(c.hasOwnProperty("calculateProduct")&&!0===c.calculateProduct){if(a.length)var b=$('input.price-unit[data-sid="'+a+'"]'),d=parseInt($('input.qty-unit[data-sid="'+a+'"]').val());else b=$('input.price-unit[data-pid="'+c.productId+'"]'),d=parseInt($('input.qty-unit[data-pid="'+c.productId+'"]').val());var h=parseFloat(accounting.unformat(b.val())),d=h*d;a.length?$('.price-total[data-sid="'+
...
{qid:$("#quote-id-payment-type").val(),type:"taxrate",value:$(e.currentTarget).val()};_update("api/quote/quotes/",d).done(function(a){hideSpinner();$.extend(d,{summary:a});recalculate(d)})}}).fail(function(a){showMessage(JSON.parse(a.responseText),!0,5E3)})};
