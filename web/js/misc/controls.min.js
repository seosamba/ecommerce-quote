...
$(document).on("click","#add-product-to-quote",function(a){updateQuote(c,!1)});$(document).on("click",".quote-control",function(a){a=$(a.currentTarget);1==parseInt(a.data("sendmail"))?showMailMessageEdit(a.data("trigger"),function(a){updateQuote(c,!0,a)},"customer"):(showLoader(),updateQuote(c,!1))});$(document).on("click",".clone-quote",function(a){$.ajax({url:$("#website_url").val()+"api/quote/quotes/",type:"post",data:{type:"clone",quoteId:c},dataType:"json",beforeSend:showSpinner()}).done(function(a){var c=
'<a href="'+$("#website_url").val()+a.id+'.html" target="_blank" title="'+a.id+'">'+$("#website_url").val()+a.id+".html</a>";hideSpinner();showMessage("The quote has been duplicated. <br/>"+c,!1,15E3);recalculate({summary:a})})});$(document).on("blur",".quote-recalculate",function(a){a=$(a.currentTarget);var b=a.data("scope"),e=a.data("type"),f=$(a).data("sid"),d={qid:c,type:e,value:a.val(),sid:f};switch(b){case "quote-item":var g=a.data("pid");d.value=accounting.unformat(d.value);a=_update("api/quote/products/id/"+
g,d);a.done(function(a){hideSpinner();$.extend(d,{calculateProduct:!0,productId:g,summary:a});recalculate(d,f)});break;case "quote-partial":a=_update("api/quote/quotes/",d),a.done(function(a){hideSpinner();$.extend(d,{summary:a});recalculate(d,f)})}});$(document).on("change","#quote-discount-rate",function(a){var b={qid:c,type:"taxrate",value:$(a.currentTarget).val()};_update("api/quote/quotes/",b).done(function(a){hideSpinner();$.extend(b,{summary:a});recalculate(b)})});$(document).on("change",".quote-disclaimer-text",
function(a){a.preventDefault();$(".quote-control-save").trigger("click");showMessage("Quote notes has been saved",!1,3E3)})});
